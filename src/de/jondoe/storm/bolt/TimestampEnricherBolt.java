 ...
 * @since 23-02-2021
 */
public class TimestampEnricherBolt extends BaseTickTupleAwareRichBolt
{
    ...
    public void process(Tuple input)
    {
        ...
        System.out.printf("%s: timestamp enriched - %s\n", componentId, jsonObject);
        this.collector.emit(input, new Values(jsonObject.toString()));
